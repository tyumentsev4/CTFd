...
class ServerConfig(object):
    ...
    CACHE_REDIS_CLUSTER: str = empty_str_cast(config_ini["server"]["REDIS_CLUSTER"])
    ...
    if CACHE_REDIS_URL or CACHE_REDIS_CLUSTER:
        CACHE_TYPE: str = "rediscluster" if CACHE_REDIS_CLUSTER else "redis"
    else:
